...
public class vgGadHelper {
	...
	public static List<VgGadExcelEntity> convertExceltoList(InputStream is)
	{
		List<VgGadExcelEntity> list = new ArrayList<>();
		try {
			...
			while(iterator.hasNext())
			{
				...
				int cellId = 0;
				VgGadExcelEntity VgGadExcel = new VgGadExcelEntity();
				while(cells.hasNext())
				{
