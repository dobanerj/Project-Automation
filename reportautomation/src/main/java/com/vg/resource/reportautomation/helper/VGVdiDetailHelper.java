		...
		try {
			...
			while(iterator.hasNext())
			{
...

				{
					...
					case 3:
						cell.setCellType(CellType.STRING);
						vdidata.setResourceName(cell.getStringCellValue());
						break;
					case 4:
						cell.setCellType(CellType.STRING);
						vdidata.setCgEmailId(cell.getStringCellValue());
						break;
					case 5:
						cell.setCellType(CellType.STRING);
						vdidata.setVgEmailId(cell.getStringCellValue());
						break;
					case 6:
						cell.setCellType(CellType.STRING);
						vdidata.setVdiName(cell.getStringCellValue());
						break;
					case 7:
						cell.setCellType(CellType.STRING);
						vdidata.setOdcLocation(cell.getStringCellValue());
						break;
					case 8:
						cell.setCellType(CellType.STRING);
