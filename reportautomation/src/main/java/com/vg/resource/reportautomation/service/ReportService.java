...
public class ReportService {
	...
	public void generateFSExcel() throws IOException, SQLException {
		    ...
		    try (Workbook workbook = new XSSFWorkbook()) {
	            ...
	            String fileName = "FSHCReport_" + formattedDate + ".xlsx";
//				File file = new File("C:/Report/"+fileName);
	
			    File file = new File(ReportUtil.HC_REPORT_GENERATE_LOCATION + fileName);	
		...
		public void generateNonFSExcel() throws IOException, SQLException {
		    ...
		    try (Workbook workbook = new XSSFWorkbook()) {
	            ...
	            // Define the file name with the current date and time
	            String fileName = "NonFSHCReport_" + formattedDate + ".xlsx";
//				File file = new File("C:/Report/"+fileName);
