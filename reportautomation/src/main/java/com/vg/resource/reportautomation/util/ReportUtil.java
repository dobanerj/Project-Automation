...
public interface ReportUtil {
	public final String query="SELECT Distinct  \"VG_GAD_DATA\".\"LI_LR_ID\" , \"VG_GAD_DATA\".CAP_EMAIL_ID ," +
			...
			"\"VG_GAD_DATA\".SUB_PRACTICE ,\"VG_GAD_DATA\".SBU ,\"VG_GAD_DATA\".FS_NON_FS_SUBK, \"VG_GAD_DATA\".BU_PORTFOLIOS,"+
			"\"VG_GAD_DATA\".LOB ,\"VG_GAD_DATA\".DE ,\"VG_GAD_DATA\".EM, \"VG_GAD_DATA\".CURRENT_STATE, \"VG_GAD_DATA\".END_DATE,\"VG_SOURCE\".\"GGID\" , \"VG_SOURCE\".AMOUNT , "+
		    ...
		    "\"VG_SOURCE\".VG_CREW_ID , \"VG_SOURCE\".SOW_ID, \"VG_VDI_DETAIL\".VG_EMAIL_ID ,"+
    ...
    public final String HC_REPORT_GENERATE_LOCATION= "C:/Users/SGHOSH31/Document/Report/HCReport.xlsx";   
