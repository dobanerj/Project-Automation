...
public interface ReportUtil {
	public final String query="select Distinct VG_GAD_DATA.LI_LR_ID, " +
			"VG_GAD_DATA.PERNR, VG_GAD_DATA.LOCAL_GRADE,VG_GAD_DATA.REGION,"+
	        "VG_GAD_DATA.PROJECT_NAME, VG_GAD_DATA.PRACTICE, VG_GAD_DATA.SUB_PRACTICE, "+
			"VG_GAD_DATA.BU_PORTFOLIOS,  VG_SOURCE.GGID, VG_SOURCE.AMOUNT,VG_SOURCE.COMMENTS, "+
			"VG_SOURCE.HOURLY_RATE, VG_SOURCE.HOURS, VG_SOURCE.JOB_ROLE, VG_SOURCE.LEVEL, "+
			"VG_SOURCE.PO,  VG_SOURCE.PRIMARY_SKILLt, VG_SOURCE.RESOURCE_NAME, "+
			"VG_VDI_DETAIL.CREWID, VG_VDI_DETAIL.RESOURCE_NAME, VG_VDI_DETAIL.CG_EMAIL_ID, "+
			"VG_VDI_DETAIL.VDI_NAME, VG_VDI_DETAIL.ODC_LOCATION, VG_VDI_DETAIL.STATUS, "+
			"VG_VDI_DETAIL.LWD, "+
