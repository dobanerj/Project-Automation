...
public interface ReportUtil {
	public final String FSquery="SELECT Distinct  \"VG_GAD_DATA\".\"LI_LR_ID\" , \"SOW_MASTER\".\"SOW_NAME\",\"VG_GAD_DATA\".\"CAP_EMAIL_ID\" ,\"VG_GAD_DATA\".\"CG MANAGER\" , " +
			   ...
			   " LEFT JOIN  \"VG_VDI_DETAIL\"  on  \"VG_SOURCE\".\"VG_CREW_ID\"  = \"VG_VDI_DETAIL\".\"VG_CREW_ID\" "+
	           " LEFT JOIN \"SOW_MASTER\" on \"SOW_MASTER\".\"SOW_ID\" =  \"VG_SOURCE\".\"SOW_ID\" ORDER BY \"VG_SOURCE\".\"RESOURCE_NAME\" ASC ";
	
		public final String NonFsquery= "SELECT Distinct \"VG_SOURCE\".\"GGID\",\"VG_SOURCE\".\"VG_CREW_ID\",\"SOW_MASTER\".\"SOW_NAME\","
		+"\"VG_SOURCE\".\"AMOUNT\",  \"VG_SOURCE\".\"COMMENTS\" , \"VG_SOURCE\".\"HOURLY_RATE\" ,\"VG_SOURCE\".\"HOURS\" ,\"VG_SOURCE\".\"JOB_ROLE\" ,"
		+ "\"VG_SOURCE\".\"PAYMENT TYPE\", \"VG_SOURCE\".\"SOW_START_DATE\", \"VG_SOURCE\".\"SOW_END_DATE\", \"VG_SOURCE\".\"LEVEL\" , \"VG_SOURCE\".\"PO\" , "
		+ "\"VG_SOURCE\".\"PRIMARY_SKILL\" ,  \"VG_SOURCE\".\"RESOURCE_NAME\" , \"VG_SOURCE\".\"ROLE_END_DATE\" , \"VG_SOURCE\".\"EXHIBIT TYPE\", \"VG_SOURCE\".\"RESOURCE TYPE\", \"VG_SOURCE\".\"VG_CREW_ID\" ,  \"VG_SOURCE\".\"SOW_ID\", \"VG_SOURCE\".\"TOTAL_CONTRACT_AMOUNT\" , \"VG_SOURCE\".\"ROLE_START_DATE\","
	   +"\"VG_NON_FS_MASTER_DATA\".\"EMP_EMAIL_ID\", \"VG_NON_FS_MASTER_DATA\".\"LOB\" ,\"VG_SOURCE\".\"VG LOCATION\","
	   +"\"VG_NON_FS_MASTER_DATA\".\"REGION\" ,\"VG_NON_FS_MASTER_DATA\".\"REVISED_REGION\","
	   +"\"VG_NON_FS_MASTER_DATA\".\"VENDOR\" ,\"VG_NON_FS_MASTER_DATA\".\"EMP_ID\" ,\"VG_NON_FS_MASTER_DATA\".\"ACCOUNT_NAME\" ,"
		+"\"VG_NON_FS_MASTER_DATA\".\"EMP_NAME\", \"VG_NON_FS_MASTER_DATA\".\"EMP_EMAIL_ID\",\"VG_NON_FS_MASTER_DATA\".\"EMP_USER_ID\", \"VG_NON_FS_MASTER_DATA\".\"DESIGNATION\" ,"
		+ "\"VG_NON_FS_MASTER_DATA\".\"PROJECT_CODE\" ,\"VG_NON_FS_MASTER_DATA\".\"PROJECT_NAME\" ,\"VG_NON_FS_MASTER_DATA\".\"START_DATE\" , \"VG_NON_FS_MASTER_DATA\".\"END_DATE\" ,\"VG_NON_FS_MASTER_DATA\".\"VG LOCATION\", \"VG_NON_FS_MASTER_DATA\".\"REVISED_REGION\" , \"VG_VDI_DETAIL\".\"VG_EMAIL_ID\" , \"VG_VDI_DETAIL\".\"VDI_NAME\" ,  \"VG_VDI_DETAIL\".\"ODC_LOCATION\",  \"VG_VDI_DETAIL\".\"STATUS\",  \"VG_VDI_DETAIL\".\"LWD\"  "
	    + "FROM \"VG_NON_FS_MASTER_DATA\"  left join   \"VG_SOURCE\" ON  \"VG_NON_FS_MASTER_DATA\".\"EMP_ID\"= \"VG_SOURCE\".\"GGID\" "
	     +"LEFT JOIN  \"VG_VDI_DETAIL\" ON  \"VG_VDI_DETAIL\".\"VG_CREW_ID\"= \"VG_SOURCE\".\"VG_CREW_ID\" "+
	    "LEFT JOIN \"SOW_MASTER\" on \"SOW_MASTER\".\"SOW_ID\" =   \"VG_SOURCE\".\"SOW_ID\" ORDER BY  \"VG_NON_FS_MASTER_DATA\".\"EMP_NAME\" ASC";
