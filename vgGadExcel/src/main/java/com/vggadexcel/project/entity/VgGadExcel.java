package com.vggadexcel.project.entity;
...
public class VgGadExcel {
	...
	public VgGadExcel(String li_lrId, double perNr, int ggid, double mycposId, String candidateId, String region,
			String finRegion, String firstName, String middleName, String lastname, String ntloginId,
			...
			String opportunityEndDate, String bookingType, String practiceType, String regionType, String cgstartDate,
