package com.vggadexcel.project.helper;
...
public class vgGadHelper {
	...
	public static List<VgGadExcel> convertExceltoList(InputStream is)
	{
		List<VgGadExcel> list = new ArrayList<>();
		try {
			...
			while(iterator.hasNext())
			{
				...
				int cellId = 0;
				VgGadExcel VgGadExcel = new VgGadExcel();
				while(cells.hasNext())
				{
					...
					case 2:
						cell.setCellType(CellType.NUMERIC);
						VgGadExcel.setGgid((int)cell.getNumericCellValue());
						break;
					case 3:
						cell.setCellType(CellType.NUMERIC);
					...
					case 70:
						cell.setCellType(CellType.STRING);
						VgGadExcel.setPracticeType(cell.getStringCellValue());
						break;
					case 71:
						cell.setCellType(CellType.STRING);
